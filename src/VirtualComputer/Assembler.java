...
public class Assembler {
    ...
    public void setOutputUser(OutputUser u) {
        outputUser = u;
    }
    ...
    public boolean assemble(File f) {
        ...
        for( int i = 0 ; i < instructions.size() ; i++ ) {
            ...
            else if( instr.getCode() == InstructionSet.EQ.getId() || instr.getCode() == InstructionSet.GREQ.getId() || instr.getCode() == InstructionSet.LEAQ.getId() || instr.getCode() == InstructionSet.GREATER.getId() || instr.getCode() == InstructionSet.LESS.getId() ) {
            ...
            } else if( instr.getCode() == InstructionSet.EQV.getId() || instr.getCode() == InstructionSet.GREQV.getId() || instr.getCode() == InstructionSet.LEAQV.getId() || instr.getCode() == InstructionSet.GREATERV.getId() || instr.getCode() == InstructionSet.LESSV.getId() ) {
            ...
            else if( instr.getCode() == InstructionSet.ADDV.getId() || instr.getCode() == InstructionSet.SUBTRACTV.getId() || instr.getCode() == InstructionSet.MULTIPLYV.getId() || instr.getCode() == InstructionSet.DIVIDEV.getId() || instr.getCode() == InstructionSet.POWV.getId() || instr.getCode() == InstructionSet.MODV.getId() ) {
